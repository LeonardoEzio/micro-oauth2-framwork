...
import leonardo.ezio.personal.entity.DeviceInfo;
...
public class ClientInfoUtil {
     ...
     * @return
     */
    public static ClientInfo get(HttpServletRequest request, boolean isDevice) {
        String userAgent = request.getHeader(CommonConstant.USER_AGENT);
        return get(userAgent,isDevice);
    }
     ...
     * @return
     */
    public static ClientInfo get(String userAgentString,boolean isDevice) {
